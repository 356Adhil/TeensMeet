...
class ClientSession extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(client, sessionPool, options, clientOptions) {
        ...
        this.supports = {
            ...
            causalConsistency: options.causalConsistency !== undefined ? options.causalConsistency : defaultCausalConsistencyValue
    ...
    get id() {
        return this[kServerSession] ? this[kServerSession].id : undefined;
    ...
    get loadBalanced() {
        if (this.client.topology && this.client.topology.description.type === common_1.TopologyType.LoadBalanced) {
          return true;
        }
        return false;
      }
    ...
    advanceClusterTime(clusterTime) {
        ...
        if (!clusterTime.signature ||
            clusterTime.signature.hash && clusterTime.signature.hash._bsontype !== 'Binary' ||
...
class ServerSessionPool {
     ...
     */
    acquire() {
        const sessionTimeoutMinutes = this.client.topology && this.client.topology.logicalSessionTimeoutMinutes ? this.client.topology.logicalSessionTimeoutMinutes : 10;
