...
class MongoSystemError extends MongoError {
    constructor(message, reason) {
        ...
        if (reason && reason.error && reason.error.code) {
...
function isRetryableReadError(error) {
    let hasRetryableErrorCode = false;
    if (typeof error.code === 'number') {
        hasRetryableErrorCode = RETRYABLE_READ_ERROR_CODES.has(error.code);
    }
